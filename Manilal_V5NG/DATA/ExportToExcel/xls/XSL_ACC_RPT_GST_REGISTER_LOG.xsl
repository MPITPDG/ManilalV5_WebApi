    ...
    <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
      ...
      <xsl:for-each select="//NewDataSet/Table1">
        ...
        <Worksheet>
          ...
          <Table ss:ExpandedColumnCount="25"  x:FullColumns="1" x:FullRows="1" ss:StyleID="s71" ss:DefaultRowHeight="15">
            ...
            <Column ss:StyleID="s71" ss:Width="61.5"/>
            ...
            <Row ss:AutoFitHeight="0" ss:Height="26.25" ss:StyleID="s81">
              ...
              <Cell ss:StyleID="s90">
                <Data ss:Type="String">INVOICE TYPE</Data>
              </Cell>
              <Cell ss:StyleID="s91">
              ...
              <Cell ss:StyleID="s90">
                <Data ss:Type="String">CUSTOM / STAMP DUTY</Data>
              </Cell>
              <Cell ss:StyleID="s90">
                <Data ss:Type="String">AIR / SEA EXP</Data>
              </Cell>
              <Cell ss:StyleID="s90">
                <Data ss:Type="String">EXEMPT</Data>
              </Cell>
              <Cell ss:StyleID="s90">
                <Data ss:Type="String">NON GST</Data>
              </Cell>
              <Cell ss:StyleID="s93">
            ...
            <xsl:for-each select="//NewDataSet/Table2">
              ...
              <xsl:if test="$ORIGIN_ID = $ORIGIN_II and $TYPE_II='II'">
                <Row ss:AutoFitHeight="1">
                  ...
                  <Cell ss:StyleID="s65">
                    <Data ss:Type="String">
                      <xsl:value-of select="INVOICE_TYPE"/>
                    </Data>
                  </Cell>
                  ...
                  <Cell ss:StyleID="s63">
                    <Data ss:Type="Number">
                      <xsl:value-of select="CUSTOM_STAMP_DUTY"/>
                    </Data>
                  </Cell>
                  <Cell ss:StyleID="s63">
                    <Data ss:Type="Number">
                      <xsl:value-of select="AIR_SEA_EXP"/>
                    </Data>
                  </Cell>
                  <Cell ss:StyleID="s63">
                    <Data ss:Type="Number">
        ...
        <Worksheet>
          ...
          <Table ss:ExpandedColumnCount="27"  x:FullColumns="1"
          ...
          <Row ss:Height="30" ss:StyleID="s62">
			...
			<xsl:for-each select="//NewDataSet/Table4">
				<Row ss:AutoFitHeight="1">
					...
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTVALUE" />
						</Data>
					</Cell>
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTNONTAXABLE" />
						</Data>
					</Cell>
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTTAXABLE" />
						</Data>
					</Cell>
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTIGST" />
						</Data>
					</Cell>
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTCGST" />
						</Data>
					</Cell>
					<Cell ss:StyleID="s188">
						<Data ss:Type="Number">
							<xsl:value-of select="TOTSGST" />
						</Data>
					</Cell>
				</Row>
			</xsl:for-each>
