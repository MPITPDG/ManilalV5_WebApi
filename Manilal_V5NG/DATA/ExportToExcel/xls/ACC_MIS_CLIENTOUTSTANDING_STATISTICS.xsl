     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet>
        ...
        <Table ss:DefaultColumnWidth="82.5">
          ...
          <Column ss:Width="87"/>
          <Column ss:Index="4" ss:AutoFitWidth="0" ss:Width="240"/>
          <Column ss:Index="10" ss:AutoFitWidth="0" ss:Width="208.5"/>
          <xsl:apply-templates select="NewDataSet"/>
          <Row >
            <Cell ss:MergeAcross="9" ss:StyleID="s010">
          ...
          <Row ss:AutoFitHeight="0" ss:Height="22.5">
            ...
            <Cell ss:StyleID="s1021">
              <Data ss:Type="String">OUTSTANDING (BALANCE * NO.of Days)</Data>
            </Cell>
          </Row>
