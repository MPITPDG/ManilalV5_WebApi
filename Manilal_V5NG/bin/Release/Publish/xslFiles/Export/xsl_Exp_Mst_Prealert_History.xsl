  ...
  <xsl:template match="/">
    <table cellpadding="2" cellspacing="0" border="0" bordercolor="white" class="infotable" WIDTH="100%">
      <tr class="DataGridFixedHeader">
        ...
        <td nowrap="1" width="50%" class="header">ALERT NAME</td>
        <td nowrap="1" width="50%" class="header">TYPE CRITERIA</td>
      ...
      <xsl:for-each select="//NewDataSet/Table2">
        <xsl:choose>
          <xsl:when test="STATUS='IN PROCESS'">
            <tr nowrap="1" class="cur" style="color:Red;" onMouseout="this.style.color='Red'" onmouseover="this.style.color='black'"  onclick="parent.fn_InProcess('{PKID}')" alt="View Curent Status {REPORTNAME}">
              ...
              <td nowrap="1" class="summaryDetail" align="left">
                <xsl:value-of select="ALERTNAME" />
                <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              </td>
              <td nowrap="1" class="summaryDetail" align="left">
                <xsl:value-of select="TYPECRITERIA" />
                <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
              </td>
              <td nowrap="1" class="summaryDetail" align="left">
