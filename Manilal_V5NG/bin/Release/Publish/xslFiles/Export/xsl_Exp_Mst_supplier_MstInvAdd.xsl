                ...
                <xsl:for-each select="//NewDataSet/Table1">
                    <tr class="summaryDetail">
                        <td class="summaryDetail"  align="center" >
                            <img src="../../include/img/edit_item.gif" class="cur"  onclick="parent.fnPopulate_Sup_MstAddr('{ID}','{SUP_CODE}','{PURDD1}','{PURADD2}','{PURADD3}','{PURINCODE}','{PURPINPOS}','{INVCITY}','{PURSTATE}','{PURCOUNTRY}','{TelePhone_No}','{Fax_No}','{GST_NO}','{GST_ARNNO}','{GSTTITLE}','{GSTCONTP}','{GSTTELNO}','{GSTMOBNO}','{GSTCONTEMAIL}','{PURSTATETIN}','{IS_GST_Registered}')" alt="Edit Details {INVADDRESS}"/>
                        ...
                        <td class="summaryDetail" NOWRAP="" align="left">
                            <xsl:value-of select="PURADDRESS" />
