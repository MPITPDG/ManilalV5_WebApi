     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet>
        ...
        <Table>
          ...
          <Column ss:Index="16" ss:Width="53.25" ss:Span="1"/>
          ...
          <xsl:for-each select="//NewDataSet/Table3">
            <Row ss:Height="16.5">
              <Cell ss:MergeAcross="19" ss:StyleID="s95">
                <Data ss:Type="String">CARGO ON HAND - AIR</Data>
              </Cell>
            </Row>
            <Row ss:Height="16.5">
              <Cell ss:MergeAcross="19" ss:StyleID="s95">
            ...
            <Row ss:Height="16.5">
			  ...
			  <Row ss:Height="16.5">
				  <Cell ss:MergeAcross="19" ss:StyleID="s95">
					  <Data ss:Type="String">Report Generated On : <xsl:value-of select="DT"/>
					  </Data>
				  </Cell>
			  </Row>  
          ...
          <Row ss:AutoFitHeight="0">
            ...
            <Cell ss:StyleID="s63">
              <Data ss:Type="String">MAWB Dt.</Data>
            </Cell>
            <Cell ss:StyleID="s63">
              <Data ss:Type="String">HAWB No.</Data>
            </Cell>
            <Cell ss:StyleID="s63">
              <Data ss:Type="String">HAWB Dt.</Data>
            </Cell>
            <Cell ss:StyleID="s63">
              <Data ss:Type="String">Planned Flight No.</Data>
            </Cell>
            <Cell ss:StyleID="s63">
              <Data ss:Type="String">Planned Flight Dt.</Data>
            </Cell>
            <Cell ss:StyleID="s63">
            ...
            <xsl:choose>
              <xsl:when test="MDD_FLAG='1'">
                <Row>
                  ...
                  <Cell ss:StyleID="s79">
                    <Data ss:Type="String">
                      <xsl:value-of select="AEROBILLNO"/>
                    </Data>
                  </Cell>
                  <Cell ss:StyleID="s79">
                    <Data ss:Type="String">
