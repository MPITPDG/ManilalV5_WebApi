  ...
  <xsl:template match="/">
    ...
    <table cellpadding="2" cellspacing="0" border="1" bordercolor="white" class="infotable" WIDTH="100%">
      <tr class="DataGridFixedHeader">
        ...
        <td nowrap="1" width="100px" class="header">Style No.</td>
        <td nowrap="1" width="80px" class="header">Gross Wgt</td>
        <td nowrap="1" width="80px" class="header">Volume</td>
      ...
      <xsl:for-each select="//NewDataSet/Table">
        <tr class="summaryDetail">
          <td class="summaryDetail"  align="center">
            <img src="../../INCLUDE/img/edit_item.gif" class="cur"  onclick="parent.fnPopulate_RecpOfCargo_Dtls('{TBL_INDEXID}','{CARGOID}','{GUID}','{EXPTNO}','{NOOFPKGS}','{RECDDATE}','{RECDTIME}','{RECDWHERE}','{RECDLOCAL}','{RECDLOCALTIME}','{ORDERNO}','{STYLENO}','{EXPT_GRWT}','{EXPT_VOLUME}')" alt="Edit Details {NOOFPKGS}"/>
            <img src="../../INCLUDE/img/thrash.gif" class="cur"  onclick="parent.fnDelete_RecpOfCargo_Dtls('{TBL_INDEXID}','{CARGOID}','{EXPTNO}','{NOOFPKGS}')" alt="Delete Details {ORDERNO} {STYLENO}'"/>
          </td>
