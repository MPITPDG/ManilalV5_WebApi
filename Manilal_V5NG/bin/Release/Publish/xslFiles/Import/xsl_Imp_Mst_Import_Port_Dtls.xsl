            ...
            <xsl:for-each select="//NewDataSet/Table">
                <tr class="row">
                    <td class="content" align="left" width="150px">
                        <xsl:value-of select="PortRecNo" />
                    </td>
                    <td class="content" align="left" width="150px">
                        <xsl:value-of select="PortPaiddt" />
                    </td>
                    <td class="content" align="left" width="150px">
                        <xsl:value-of select="PortAmount" />
                    </td>
                    <td class="content" align="left" width="200px">
                        <xsl:value-of select="PortRemark" />
                    </td>
                    <td class="content"  align="center" width="50px">
                        <img src="../../INCLUDE/img/edit_item.gif" class="cur"  onclick="fnEdit_Port_Dtls('{pk_tblIndex}','{PortRecNo}','{PortPaiddt}','{PortAmount}','{PortRemark}')" alt="Edit Port Details {PortRecNo}"/>
                        <img src="../../INCLUDE/img/thrash.gif" class="cur"  onclick="fnDelete_Port_Dtls('{pk_tblIndex}','{PortRecNo}')" alt="Delete Port Details{PortRecNo}"/>
                    </td>
                </tr>
            </xsl:for-each>
            <tr valign="top">
