					...
					<table border='0' cellpadding='1' cellspacing='1' width='750px'>
						...
						<xsl:for-each select="//NewDataSet/Table2">
							<tr>
								...
								<td class="summaryDetail_xslt" colspan="3" width="550px">
									<xsl:value-of select="CLIENTNAME" disable-output-escaping="yes"/>
									<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="lblNormal_xslt" width="200px" color="blue">
									Bill To Address
								</td>
								<td class="summaryDetail_xslt" colspan="3" >
									<xsl:value-of select="BILLTO_INVADDR" disable-output-escaping="yes"/>
									<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
								</td>
							</tr>
							<tr class="DataGridHeader_xslt">
								<td class="header" colspan="4" height="4px">
							...
							<tr>
								...
								<td class="summaryDetail_xslt" width="200px">
									<xsl:value-of select="INV_NOOFPCS" disable-output-escaping="yes"/> 
									<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
								</td>
								<td class="lblNormal_xslt" width="200px" >
									Weight Kilo
								...
								<table border='0' cellpadding='1'  cellspacing='1' width='750px' >
									...
									<xsl:for-each select="//NewDataSet/Table5">
										...
										<!--<tr>
											...
											<td  class="lblNumber_xslt" colspan="2">
									...
									<xsl:for-each select="//NewDataSet/Table9">
										<tr>
											<td  class="summaryDetail_xslt"  colspan="5">
												<xsl:value-of select="DESC1" disable-output-escaping="yes"/>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											</td>
											<td class="summaryDetail_xslt">
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											...
											<td  class="lblNumber_xslt" >
												<xsl:value-of select="INV_INRAMT" disable-output-escaping="yes"/>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											</td>
										</tr>
									</xsl:for-each>
