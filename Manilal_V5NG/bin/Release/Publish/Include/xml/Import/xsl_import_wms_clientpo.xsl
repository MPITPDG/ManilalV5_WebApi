                  ...
                  <Table>
                    ...
                    <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                      ...
                      <Cell ss:StyleID="s68">
                       ...
                       <Cell ss:StyleID="s68">
                        <Data ss:Type="String">Grn Box No</Data>
                      </Cell>
                       ...
                       <xsl:choose>
                          <xsl:when test="FLAG = '0'">
                            ...
                            <Cell ss:StyleID="s69"><Data ss:Type="String"><xsl:value-of select="CONTAINERNO"/></Data></Cell>
                             <Cell ss:StyleID="s69"><Data ss:Type="String"><xsl:value-of select="PONO"/></Data></Cell>
                              <Cell ss:StyleID="s69"><Data ss:Type="String"><xsl:value-of select="BOXNO"/></Data></Cell>
                           <Cell ss:StyleID="s69"><Data ss:Type="String"><xsl:value-of select="GRNBOXNO"/></Data></Cell>
                          </xsl:when>
                          <xsl:otherwise>
                            <Cell ss:StyleID="s69">
                              <Data ss:Type="String">
