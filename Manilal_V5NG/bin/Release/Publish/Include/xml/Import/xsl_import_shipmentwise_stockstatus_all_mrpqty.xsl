                  ...
                  <Table>
                    ...
                    <xsl:for-each select="//NewDataSet/Table">
                      <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                        ...
                        <Cell ss:StyleID="s68">
                          <Data ss:Type="String">MRPLBL Pending Qty</Data>
                        </Cell>
                      ...
                      <xsl:for-each select="//NewDataSet/Table">
                        <Row>
                          ...
                          <Cell ss:StyleID="s71">
                            <Data ss:Type="Number">
                              <xsl:value-of select="MRPPENDING"/>
                            </Data>
                          </Cell>
                    ...
                    <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">AVAIL STOCK</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">Container Wise Balance</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">Mrp Details</Data>
                      </Cell>
                    ...
                    <xsl:for-each select="//NewDataSet/Table1">
                      <Row>
                        ...
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="String">
                            <xsl:value-of select="MRP_DETAILS"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="String">
