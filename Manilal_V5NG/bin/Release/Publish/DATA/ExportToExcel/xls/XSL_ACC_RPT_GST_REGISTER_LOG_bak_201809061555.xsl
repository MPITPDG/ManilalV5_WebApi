  ...
  <xsl:template match="NewDataSet">
    <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
      ...
      <xsl:for-each select="//NewDataSet/Table1">
        ...
        <Worksheet>
          ...
          <Table ss:ExpandedColumnCount="19" ss:ExpandedRowCount="549" x:FullColumns="1"
   x:FullRows="1" ss:StyleID="s71" ss:DefaultRowHeight="15">
            ...
            <xsl:for-each select="//NewDataSet/Table">
              <Row ss:Height="15.75">
                <Cell ss:MergeAcross="18" ss:StyleID="s143">
                  <Data ss:Type="String">
              ...
              <Row ss:Height="15.75">
                <Cell ss:MergeAcross="18" ss:StyleID="s144">
                  <Data ss:Type="String">
        ...
        <Worksheet>
          ...
          <Table ss:ExpandedColumnCount="22" ss:ExpandedRowCount="58" x:FullColumns="1"
   x:FullRows="1" ss:StyleID="s71" ss:DefaultRowHeight="15">
