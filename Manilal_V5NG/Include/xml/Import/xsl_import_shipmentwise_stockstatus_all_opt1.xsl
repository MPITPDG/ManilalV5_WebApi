                  ...
                  <Table>
                    ...
                    <xsl:for-each select="//NewDataSet/Table">
                      <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                        <Cell ss:StyleID="s68">
                          <Data ss:Type="String">DataFile Qty</Data>
                        </Cell>
                    
                        <Cell ss:StyleID="s68">
                          <Data ss:Type="String">Shipment Qty</Data>
                        </Cell>
                        <Cell ss:StyleID="s68">
                          <Data ss:Type="String">Receipt Qty</Data>
                        </Cell>
                        <Cell ss:StyleID="s68">
                      ...
                      <xsl:for-each select="//NewDataSet/Table">
                        <Row>
                          <Cell ss:StyleID="s71">
                            <Data ss:Type="Number">
                              <xsl:value-of select="DATAFILEQTY"/>
                            </Data>
                          </Cell>
                    ...
                    <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">OPENING QTY</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">RECEIPT QTY</Data>
                      </Cell>
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2410-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2412-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2502-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2505-MRP]</Data>
                      </Cell>
                       <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2506-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2508-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2510-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2510-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2511-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2511-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2410-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2412-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2502-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2505-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2506-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2508-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2510-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2510-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2511-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2511-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                    ...
                    <xsl:for-each select="//NewDataSet/Table1">
                      <Row>
                        ...
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2410-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2412-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2502-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2505-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2506-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2508-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2510-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2510-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2511-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2511-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                        ...
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2410-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2412-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2502-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2505-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2506-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2508-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2510-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2510-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2511-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2511-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="String">
