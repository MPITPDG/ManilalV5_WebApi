          ...
          <Worksheet ss:Name="StockStatus">
                  ...
                  <Table>
                    ...
                    <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2411-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2501-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2504-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2505-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[SEA-2505-MRP]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">[LOC-2411-BALQTY]</Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                    ...
                    <xsl:for-each select="//NewDataSet/Table1">
                      <Row>
                        ...
                        <Cell ss:StyleID="s69">
                          ...
                          <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2411-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2501-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2504-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                        ...
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='SEA-2505-MRP']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                        ...
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="Number">
                            <xsl:value-of select="*[local-name()='LOC-2411-BALQTY']"/>
                          </Data>
                        </Cell>
                        <Cell ss:StyleID="s69">
                          <Data ss:Type="String">
