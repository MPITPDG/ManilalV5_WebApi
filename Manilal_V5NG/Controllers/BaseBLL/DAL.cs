...
namespace Manilal_V5NG.BaseBLL
{
    public class DAL
    {
        ...
        //internal DataSet ExecuteDataset(object getConnString, CommandType storedProcedure, string v, object trim, string fkReportId, string searchCTA, string sqlQueryPARA)
        //{
