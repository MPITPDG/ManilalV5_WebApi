        ...
        <table cellpadding="2" cellspacing="0" border="1" bordercolor="white" class="infotable" WIDTH="100%">
          <xsl:for-each select="//NewDataSet/Table">
            ...
            <tr class="DataGridFixedHeader">
                ...
                <td nowrap="1" width="100px" class="header">Ref. No</td>
                ...
                <td nowrap="1" width="100px" class="header">Pcs Type</td>
                ...
                <td nowrap="1" width="100px" class="header">Booking On</td>
                <td nowrap="1" width="100px" class="header">CargoRecvdE</td>
                <td nowrap="1" width="100px" class="header">DocsRecvdE</td>
                ...
                <td nowrap="1" width="100px" class="header">Approval Dt</td>
                <td nowrap="1" width="100px" class="header">Approval By</td>
              <xsl:if test="$GrpId='2'">
                <td nowrap="1" width="100px" class="header">Sup.Contact dt.</td>
