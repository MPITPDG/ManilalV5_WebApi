					...
					<Table ss:DefaultColumnWidth="82.5" ss:DefaultRowHeight="15">
						...
						<!--<xsl:when test="$CONNAME='EPHIGEA'">
								<Row ss:AutoFitHeight="0" ss:Height="25.5">
									...
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">DEST AIRPORT</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">SHIPPER</Data>
									</Cell>
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">SHPT OK RECEIVED ON</Data>
									</Cell>
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">AIRPORT OF DEPARTURE</Data>
									</Cell>
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">BOOKING RECEIVED ON</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">CARGO RECEIVED ON</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">DOX RECEIVED ON</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">MAWB</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">HAWB</Data>
									</Cell>
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">AIRLINE</Data>
									</Cell>
									<Cell ss:StyleID="s64">
									...
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">DATE LIV</Data>
									</Cell>
									<Cell ss:StyleID="s64">
									...
									<Cell ss:StyleID="s65">
										<Data ss:Type="String">Our Remarks</Data>
									</Cell>
								</Row>
								<xsl:for-each select="//NewDataSet/Table2">
									...
									<xsl:if test="$ORIGIN_ID = $ORIGIN_F">
										<Row ss:AutoFitHeight="1">
											...
											<Cell ss:StyleID="s68">
												<Data ss:Type="String">
													<xsl:value-of select="SHPT_OK_RECEIVED_ON"/>
												</Data>
											</Cell>
											<Cell ss:StyleID="s68">
												<Data ss:Type="String">
													<xsl:value-of select="AIRPORTOFDEPARTURE"/>
												</Data>
											</Cell>

											<xsl:choose>
												<xsl:when test="$BKNGECVDON = 'Org Docs Not Recvd'">
													<Cell ss:StyleID="s70">
														<Data ss:Type="String">
															<xsl:value-of select="BOOKINGRECEIVEDON"/>
														</Data>
													</Cell>
												</xsl:when>
												<xsl:otherwise>
											...
											<Cell ss:StyleID="s67">
												<Data ss:Type="String">
													<xsl:value-of select="CARGORECEIVEDON"/>
												</Data>
											</Cell>
											<Cell ss:StyleID="s71">
												<Data ss:Type="String">
													<xsl:value-of select="DOXRECEIVEDON"/>
												</Data>
											</Cell>
											<Cell ss:StyleID="s69">
												<Data ss:Type="String">
											...
											<Cell ss:StyleID="s71">
												<Data ss:Type="String">
													<xsl:value-of select="TAXABLEWEIGHT"/>
												</Data>
											</Cell>
											<Cell ss:StyleID="s71">
												<Data ss:Type="String">
											...
											<Cell ss:StyleID="s69">
												<Data ss:Type="String">
													<xsl:value-of select="OurRemarks"/>
												</Data>
											</Cell>
										</Row>
									</xsl:if>
						...
						<!--<xsl:when test="$CONNAME='JULES'">
								<Row ss:AutoFitHeight="0" ss:Height="25.5">
									...
									<Cell ss:StyleID="s64">
										<Data ss:Type="String">COLOUR</Data>
									</Cell>
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">ACCOUNT</Data>
									</Cell>
									...
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">GREENLIGHT RECEIVED ON</Data>
									</Cell>
									<Cell ss:StyleID="s63">
										<Data ss:Type="String">AIRPORT OF DEPARTURE</Data>
									</Cell>
								...
								<xsl:for-each select="//NewDataSet/Table2">
									...
									<xsl:if test="$ORIGIN_ID = $ORIGIN_F">
										<Row ss:AutoFitHeight="1">
											...
											<Cell ss:StyleID="s68">
												<Data ss:Type="String">
													<xsl:value-of select="GREENLIGHTRECEIVEDON"/>
												</Data>
											</Cell>
											<Cell ss:StyleID="s68">
												<Data ss:Type="String">
						...
						<Row ss:AutoFitHeight="0" ss:Height="25.5">
							...
							<Cell ss:StyleID="s63">
								<Data ss:Type="String">AIRPORT OF ORIGIN</Data>
							</Cell>
							<Cell ss:StyleID="s63">
								<Data ss:Type="String">SHIPPER</Data>
							</Cell>
							...
							<Cell ss:StyleID="s63">
								<Data ss:Type="String">ITEM REF</Data>
							</Cell>
							<Cell ss:StyleID="s63">
								<Data ss:Type="String">DATE OF RECEIPT OF THE GOODS</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">DATE OF RECEIPT OF DOCUMENTS</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">NUMBER OF PCS.</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">NUMBER OF CARTONS</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">GROSS WEIGHT IN KG</Data>
							</Cell>
							<Cell ss:StyleID="s64">
							...
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">ETA LIL</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">MAWB</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">FREIGHT TERM</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">CHARGEABLE WEIGHT</Data>
							</Cell>
							<Cell ss:StyleID="s64">
								<Data ss:Type="String">REMARKS</Data>
							</Cell>
