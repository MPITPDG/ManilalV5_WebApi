		...
		<html>
			...
			<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" onclick="outliner();">
				...
				<!--<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="white" class="infotable">
								...
								<table >
									<tr class="formHeading">
										<td  width="10px" class="summaryDetail">
											<IMG border="0" alt="expand/collapse section" id="con_sum{FREIGHT}p" child="con_sum{FREIGHT}" class="expandable" height="11" onclick="changepic()" src="../../include/img/img_Plus.gif" width="9" ></IMG>
										</td>
										<td colspan ='4' class="header">
											Purchase Details Against MP India Airfreight Invoice
											<tr >
												...
												<table class="collapsed" bgcolor="#ffffff" id="src{FREIGHT}" border="1"    cellpadding="1" cellspacing="1" width="100%">
													<tr class="DataGridHeader_xslt">
					...
					<tr>
						<td colspan="4">
							<table class="collapsed" bgcolor="#ffffff" id="src{ENTRYDT}" width="100%">

								<td width="10px" class="summaryDetail">
									<IMG border="0" alt="expand/collapse section" id="con_sum1{ENTRYDT}p" child="con_sum1{ENTRYDT}" class="expandable" height="11" onclick="changepic()" src="../../include/img/img_Plus.gif" width="9" ></IMG>
								</td>
								<td colspan="4"  class="summaryDetail">
									Purchase Details Against MP India Share of Profit Credit Note Details

								</td>
								<tr class="collapsed" bgcolor="#ffffff" id="con_sum1{ENTRYDT}">
