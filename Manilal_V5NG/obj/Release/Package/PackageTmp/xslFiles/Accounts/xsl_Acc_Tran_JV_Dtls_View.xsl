  ...
  <xsl:template match="/">
    <table cellpadding="0" cellspacing="0" border="0" bordercolor="white" class="infotable" WIDTH="750px">
      <tr class="DataGridFixedHeader">
        ...
        <td nowrap="1" width="80px" class="header">Debit</td>
        <td nowrap="1" width="80px" class="header">Credit</td>        
      ...
      <xsl:for-each select="//NewDataSet/Table">
        ...
        <tr class="summaryDetail">
          <!--<td class="summaryDetail"  align="center" >
            <img src="../../include/img/edit_item.gif" class="cur"  onclick="parent.fnPopulate_JV_Dtls('{ID}','{ENTRYNO}','{CLIENT}','{JOBNO}','{BILLNO}','{DEBIT}','{CREDIT}','{ENTRYTYPE}','{JV_TRANS}','{NARRATION}','{ITEMCODE}','{DEPTID}','{VGUID}','{ACCOUNT_NAME}','{ITEM}','{DEPARTMENT}','{JV_dtls_ID}','{JV_STATUS}','{ISJOBREPORT}','{ITEM_DATAVALUE}')" alt="Edit Details {ACCOUNT_NAME}"/>
            <img src="../../include/img/thrash.gif" class="cur"  onclick="parent.fnDelete_JV_Dtls('{ID}','{VGUID}','{JV_dtls_ID}')" alt="Delete Details {ACCOUNT_NAME}" />
          </td>-->
