          ...
          <Worksheet ss:Name="{worksheetName}">
                  <Table>
                    ...
                    <Row ss:AutoFitHeight="0" ss:StyleID="s67">
                      ...
                      <Cell ss:StyleID="s68">
                        <Data ss:Type="String">Old Po No </Data>
                      </Cell>
                      <Cell ss:StyleID="s68">
                      ...
                      <Row>
                       <xsl:choose>
                          <xsl:when test="FLAG = '0'">
                            ...
                            <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="String"><xsl:value-of select="RACKNO"/></Data></Cell>
                            <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="Number"><xsl:value-of select="PO_QTY"/></Data></Cell>
                            <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="Number"><xsl:value-of select="CL_STOCK"/></Data></Cell>
                            <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="String"><xsl:value-of select="CONTAINERNO"/></Data></Cell>
                             <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="String"><xsl:value-of select="PONO"/></Data></Cell>
                              <Cell ss:StyleID="StrikeThroughStyle"><Data ss:Type="String"><xsl:value-of select="BOXNO"/></Data></Cell>
                          </xsl:when>
                          <xsl:otherwise>
                            <Cell ss:StyleID="s69">
                              <Data ss:Type="String">
