  ...
  <xsl:template match="/">
    <table cellpadding="2" cellspacing="0" border="1" bordercolor="white" class="SummaryDetail" WIDTH="100%">
      <tr class="DataGridFixedHeader">
        ...
        <th nowrap="1" rowspan="2" valign="Top">
          FRIGHT + DEST.CHARGES EURO
        </th>
        <th nowrap="1"></th>
      </tr>
      <tr class="DataGridFixedHeader">
        <th class="locked" nowrap="1" width="5px">
        ...
        <th nowrap="1">PKGS</th>
        <th nowrap="1">Gross Weight</th>
        <th nowrap="1">Volume (Weight)</th>
        <th nowrap="1">Volume (CBM)</th>
        ...
        <th nowrap="1">FORFAIT DOUANE IMPORT</th>
        <th nowrap="1">TOTAL EURO</th>
