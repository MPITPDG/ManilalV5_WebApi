    ...
    <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet>
        ...
        <Table ss:DefaultColumnWidth="82.5">
          ...
          <xsl:if test="count(Table1/*)>0">
            <Row ss:AutoFitHeight="0" ss:Height="22.5">
              ...
              <Cell ss:StyleID="s1011">
                <Data ss:Type="String">TOTAL INR</Data>
              </Cell>
              <Cell ss:StyleID="s1011">
              ...
              <Cell ss:StyleID="s1011">
                <Data ss:Type="String">FOB Charges at origin (DAC)</Data>
              </Cell>
              <Cell ss:StyleID="s1011">
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <Row ss:AutoFitHeight="1">
                    ...
                    <Cell ss:StyleID="s250">
                      <Data ss:Type="String">TOTAL MAWB</Data>
                    </Cell>
                    <Cell ss:StyleID="s25">
                      <Data ss:Type="String"></Data>
                    </Cell>
		...
		<Worksheet>
			<xsl:attribute name="ss:Name">Invoice_HappyChic_Format</xsl:attribute>
			<Table ss:DefaultColumnWidth="82.5">
				<Column ss:Index="2" ss:AutoFitWidth="0" ss:Width="156"/>
				<Column ss:Width="223.5"/>
				<Column ss:AutoFitWidth="0" ss:Width="205.5"/>
				...
				<xsl:if test="count(Table4/*)>0">
					<Row ss:AutoFitHeight="0" ss:Height="22.5">
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">n° MAWB</Data>
						</Cell>
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">ORIGIN</Data>
						</Cell>
						...
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">n° Préfactration transitaire</Data>
						</Cell>
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">HAWB</Data>
						</Cell>
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">numéros des  commandes</Data>
						</Cell>
						<Cell ss:StyleID="s1010">
							<Data ss:Type="String">Enseigne</Data>
						</Cell>
						<Cell ss:StyleID="s1011">
							<Data ss:Type="String">N° Colis</Data>
						</Cell>
						<Cell ss:StyleID="s1011">
							<Data ss:Type="String">Poigs (GW)</Data>
						</Cell>
						<Cell ss:StyleID="s1011">
						...
						<Cell ss:StyleID="s1011">
							<Data ss:Type="String">Frais arrivée </Data>
						</Cell>
						<Cell ss:StyleID="s1011">
