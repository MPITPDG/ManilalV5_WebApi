                      ...
                      <td colspan="9" class="summaryDetail">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr class="formHeading">
                            ...
                            <td width="75px" class="formHeading"> QC to Perform</td>
                            <td width="75px" class="formHeading"> Company QC</td>
                            <td width="75px" class="formHeading"> Date of CQ </td>
                            <td width="80px" class="formHeading"> Date ok CQ</td>
                            <td width="150px" class="formHeading">Result of CQ </td>

                            <td width="150px" class="formHeading">RAR Recvd</td>
							  <td width="75px" class="formHeading"> CODE FAMILLE </td>
                          </tr>
                          <xsl:for-each select="//NewDataSet/Table1">
                            ...
                            <xsl:if test="$ID = ID_ORDERNOSTYLENO">
                              <tr>
                                ...
                                <td class="summaryDetail" style="text-align:left;">
                                  <label style="color: #0000FF" >
                                    <xsl:value-of select="CTL_CQ" />
                                    <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                  </label>
                                </td>
                                <td class="summaryDetail" style="text-align:left;">
                                  <label style="color: #0000FF" >
                                    <xsl:value-of select="SUPP_CQ" />
                                    <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                  </label>
                                </td>
                                <td class="summaryDetail" style="text-align:left;">
                              ...
                              <tr>
                                <xsl:for-each select="//NewDataSet/Table2">
                                  <xsl:variable name="BKD_ORDERNOSTYLENO" select="ID_ORDERNOSTYLENO"></xsl:variable>
                                  <xsl:if test="ID_ORDERNOSTYLENO = $IN_ORDERNOSTYLENO">
                                    <tr>
                                      <td></td>
                              ...
                              <tr>
                                ...
                                <td class="summaryDetail" style="text-align:left;"  >
                                  <label style="color: #0000FF" >
                                    ...
                                    <xsl:variable name="second1" select="substring-after($remaining, ', ')" />
