        ...
        <xsl:choose>
          ...
          <xsl:when test="STATUS='DOWNLOAD PENDING'">
            <tr nowrap="1"  class="summaryDetail" style="color:Green;">
              <td class="summaryDetail" align="center" >
                <div width="100%" align="center">
                  <img src="../../include/img/download.gif" class="cur"  onclick="parent.fn_Download('{PKID}','{MODE}');window.open('../../DATA/EDI/output/{FILENAME}','','toolbar=no,menubar=no,width=10,height=10,top=0,left=0,scrollbars=no')" alt="Download Report {REPORTNAME}"/>
                </div>
              </td>
              <td nowrap="1" class="summaryDetail" align="left">
