        ...
        <xsl:for-each select="//NewDataSet/Table">
          <tr class="summaryDetail">
            <td class="summaryDetail"  align="center" >
              <img src="../../include/img/edit_item.gif" class="cur"  onclick="parent.fnPopulate_Provision_BeforeInv('{ID}','{PRO_JOBNO}','{SUPPLIER}','{ACCOUNT}','{AMOUNT}','{PRO_TYPE}','{FK_TRUCKID}','{IS_NOT_EDIT_ABLE}','{REMARK}','{ISAUTHORISED}','{TYPENAME}','{ISEDIT_BI}')" alt="Edit Provision Details {ACCOUNT_NAME}"/>
