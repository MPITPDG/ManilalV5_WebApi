      ...
      <Worksheet>
        ...
        <xsl:for-each select="//NewDataSet/Table1">
          ...
          <Table>
            ...
            <xsl:apply-templates select="NewDataSet"/>
            <Row ss:Height="18.75">
              <Cell ss:MergeAcross="6" ss:StyleID="m47186592">
                <Data ss:Type="String">DELIVERY WISE INV JOB PENDING FOR INVOICING</Data>
              </Cell>
            </Row>
            <Row ss:AutoFitHeight="0">
              <Cell ss:StyleID="s63">
              ...
              <Cell ss:StyleID="s63">
                <Data ss:Type="String">DELIVERY DT</Data>
              </Cell>
              <Cell ss:StyleID="s63">
                <Data ss:Type="String">JOBNO </Data>
              </Cell>
              ...
              <Cell ss:StyleID="s63">
                <Data ss:Type="String">DEL.ENTERY DT</Data>
              </Cell>

              <Cell ss:StyleID="s63">
                <Data ss:Type="String">DEL.ENTERED BY</Data>
              </Cell>
            ...
            <xsl:for-each select="//NewDataSet/Table2">
              <Row >
                ...
                <Cell ss:StyleID="s66">
                  <Data ss:Type="String">
                    <xsl:value-of select="Deliverydt"/>
                  </Data>
                </Cell>
                <Cell ss:StyleID="s66">
                  <Data ss:Type="String">
